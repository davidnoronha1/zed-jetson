...
bool custom_msgs__msg__telemetry__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_msgs.msg._telemetry.Telemetry", full_classname_dest, 36) == 0);
  }
  custom_msgs__msg__Telemetry * ros_message = _ros_message;
  {  // x
...
PyObject * custom_msgs__msg__telemetry__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_msgs.msg._telemetry");
